            ...
            {navItems.map((item) => {
                    ...
                    return (
                        <div key={item.id} className="relative h-full flex items-center">
                            <button
                                ...
                                className={`group relative flex items-center px-4 py-3 h-full transition-all duration-200 rounded-lg mx-1 ${isSandboxItemActive
                            ...
                            >
                                <div className="flex items-center space-x-2">
                                    <span className={`relative z-10 transition-all duration-200 ${isSandboxItemActive ? 'scale-110' : 'group-hover:scale-110'}`}>
                                        <span className={`absolute inset-0 rounded-full bg-gradient-to-r ${item.gradient} opacity-0 group-hover:opacity-100 blur-md transition-opacity duration-200 ${isSandboxItemActive ? 'opacity-100' : ''
                                            }`}></span>
                                        ...
                                        return (
                                            <div key={subItem.id} className="w-full">
                                                <Link
                                                    ...
                                                    className={`flex items-center px-4 py-3 text-sm ${isSubItemActive
                ...
                return (
                    <Link
                        key={item.id}
                        to={item.path || '#'}
                        className={`group relative flex items-center px-4 py-3 h-full transition-all duration-200 rounded-lg mx-1 ${isActive
                                ? `${item.activeText} ${item.activeBg} bg-gradient-to-r shadow-lg`
                                : `text-gray-400 ${item.hoverBg} hover:text-gray-200`
                            }`}
                    >
                        <div className="flex items-center space-x-3">
                            <span className={`relative z-10 transition-all duration-200 ${isActive ? 'scale-110' : 'group-hover:scale-110'}`}>
                                <span className={`absolute inset-0 rounded-full bg-gradient-to-r ${item.gradient} opacity-0 group-hover:opacity-100 blur-md transition-opacity duration-200 ${isActive ? 'opacity-100' : ''
                                    }`}></span>
                                <span className="relative z-10">{item.icon}</span>
                            </span>
                            <span className="font-medium text-sm relative z-10">
                                {item.label}
                                <span className={`absolute -bottom-1 left-0 w-full h-0.5 bg-gradient-to-r ${item.gradient} transition-all duration-300 transform ${isActive ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
                                    }`}></span>
                            </span>
                        </div>
                    </Link>
